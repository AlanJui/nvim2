...
map("n", "<ESC>j", "<cmd>wincmd j<CR>")
map("n", "<ESC>h", "<cmd>wincmd h<CR>")
map("n", "<ESC>l", "<cmd>wincmd l<CR>")
...
-- map("n", "<S-Up>", "<cmd>wincmd k<CR>")
-- map("n", "<S-Down>", "<cmd>wincmd j<CR>")
-- map("n", "<S-Left>", "<cmd>wincmd h<CR>")
